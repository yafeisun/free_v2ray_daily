...
from src.collectors.youneedwin import YouNeedWinCollector
...
def main():
    """主函数"""
    logger = get_logger("youneedwin")
    file_handler = FileHandler()
    
    try:
        # 初始化收集器
        site_name = 'youneedwin'
        collector = YouNeedWinCollector(WEBSITES[site_name])
